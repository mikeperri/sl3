...
import * as import32 from './github/shared/github.service';
import * as import33 from '@angular/core/src/di/injector';
import * as import34 from './home/home.component.ngfactory';
import * as import35 from './about/about.component.ngfactory';
import * as import36 from './github/repo-browser/repo-browser.component.ngfactory';
import * as import37 from './github/repo-list/repo-list.component.ngfactory';
import * as import38 from './github/repo-detail/repo-detail.component.ngfactory';
import * as import39 from './contact/contact.component.ngfactory';
...
import * as import48 from './home/home.component';
import * as import49 from './about/about.component';
import * as import50 from './github/repo-browser/repo-browser.component';
import * as import51 from './github/repo-list/repo-list.component';
import * as import52 from './github/repo-detail/repo-detail.component';
import * as import53 from './contact/contact.component';
...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  __GithubService_57:import32.GithubService;
  constructor(parent:import33.Injector) {
    super(parent,[
      import34.HomeComponentNgFactory,
      import35.AboutComponentNgFactory,
      import36.RepoBrowserComponentNgFactory,
      import37.RepoListComponentNgFactory,
      import37.RepoListComponentNgFactory,
      import38.RepoDetailComponentNgFactory,
      import38.RepoDetailComponentNgFactory,
  ...
  get _APP_ID_18():any {
    if ((this.__APP_ID_18 == null)) { (this.__APP_ID_18 = import41._appIdRandomProviderFactory()); }
  ...
  get _EventManager_22():import15.EventManager {
    if ((this.__EventManager_22 == null)) { (this.__EventManager_22 = new import15.EventManager(this._EVENT_MANAGER_PLUGINS_21,this.parent.get(import44.NgZone))); }
  ...
  get _RootRenderer_26():any {
    if ((this.__RootRenderer_26 == null)) { (this.__RootRenderer_26 = import45._createConditionalRootRenderer(this._DomRootRenderer_25,this.parent.get(import45.NgProbeToken,(null as any)))); }
  ...
  get _ROUTER_CONFIGURATION_42():any {
    if ((this.__ROUTER_CONFIGURATION_42 == null)) { (this.__ROUTER_CONFIGURATION_42 = {useHash: true}); }
    return this.__ROUTER_CONFIGURATION_42;
  }
  get _LocationStrategy_43():any {
    if ((this.__LocationStrategy_43 == null)) { (this.__LocationStrategy_43 = import8.provideLocationStrategy(this.parent.get(import46.PlatformLocation),this.parent.get(import47.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_42)); }
  ...
  get _ROUTES_48():any[] {
      if ((this.__ROUTES_48 == null)) { (this.__ROUTES_48 = [[
        ...
        {
          path: 'github',
          component: import50.RepoBrowserComponent,
          children: [
            {
              path: '',
              component: import51.RepoListComponent
            }
            ,
            {
              path: ':org',
              ...
              children: [
                {
                  path: '',
                  component: import52.RepoDetailComponent
                }
                ,
                {
                  path: ':repo',
        ...
        {
          path: 'contact',
          component: import53.ContactComponent
        }
  ...
  get _Router_49():any {
    if ((this.__Router_49 == null)) { (this.__Router_49 = import8.setupRouter(this._ApplicationRef_16,this._UrlSerializer_45,this._RouterOutletMap_46,this._Location_44,this,this._NgModuleFactoryLoader_47,this._Compiler_17,this._ROUTES_48,this._ROUTER_CONFIGURATION_42,this.parent.get(import54.UrlHandlingStrategy,(null as any)))); }
  ...
  get _GithubService_57():import32.GithubService {
    if ((this.__GithubService_57 == null)) { (this.__GithubService_57 = new import32.GithubService(this._Http_41)); }
    return this.__GithubService_57;
  }
  createInternal():import1.AppModule {
    ...
    this._ROUTER_FORROOT_GUARD_7 = import8.provideForRootGuard(this.parent.get(import55.Router,(null as any)));
    ...
    this._Testability_14 = new import11.Testability(this.parent.get(import44.NgZone));
    this._ApplicationRef__15 = new import12.ApplicationRef_(this.parent.get(import44.NgZone),this.parent.get(import56.Console),this,this._ErrorHandler_12,this,this._ApplicationInitStatus_13,this.parent.get(import11.TestabilityRegistry,(null as any)),this._Testability_14);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import57.LOCALE_ID)) { return this._LOCALE_ID_10; }
    if ((token === import9.NgLocalization)) { return this._NgLocalization_11; }
    if ((token === import58.ErrorHandler)) { return this._ErrorHandler_12; }
    ...
    if ((token === import41.APP_ID)) { return this._APP_ID_18; }
    if ((token === import59.DOCUMENT)) { return this._DOCUMENT_19; }
    ...
    if ((token === import60.AnimationDriver)) { return this._AnimationDriver_24; }
    if ((token === import17.DomRootRenderer)) { return this._DomRootRenderer_25; }
    if ((token === import61.RootRenderer)) { return this._RootRenderer_26; }
    if ((token === import18.DomSanitizer)) { return this._DomSanitizer_27; }
    if ((token === import62.Sanitizer)) { return this._Sanitizer_28; }
    if ((token === import19.ViewUtils)) { return this._ViewUtils_29; }
    if ((token === import63.IterableDiffers)) { return this._IterableDiffers_30; }
    if ((token === import64.KeyValueDiffers)) { return this._KeyValueDiffers_31; }
    ...
    if ((token === import67.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_47; }
    if ((token === import68.ROUTES)) { return this._ROUTES_48; }
    if ((token === import55.Router)) { return this._Router_49; }
    if ((token === import69.ActivatedRoute)) { return this._ActivatedRoute_50; }
    ...
    if ((token === import41.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_56; }
    if ((token === import32.GithubService)) { return this._GithubService_57; }
